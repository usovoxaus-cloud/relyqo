...
BUILTINS = {
    ...
    "CLINIC": ("Клиники и медицинские центры", "HEALTH"),
    "DENTAL": ("Стоматологии", "HEALTH"),
    "PHARMACY": ("Аптеки", "HEALTH"),
    "VETERINARY": ("Ветеринарные клиники", "HEALTH"),
    "FITNESS": ("Фитнес и спорт", "OTHER"),
    "TRAVEL_AGENCY": ("Туризм и турагентства", "PROFESSIONAL_SERVICE"),
    "DELIVERY": ("Доставка и курьерские услуги", "PROFESSIONAL_SERVICE"),
    "CLEANING": ("Клининг и уборка", "PROFESSIONAL_SERVICE"),
    "HOME_REPAIR": ("Ремонт и строительство", "PROFESSIONAL_SERVICE"),
    "APPLIANCE_REPAIR": ("Ремонт техники", "PROFESSIONAL_SERVICE"),
    "LEGAL_SERVICE": ("Юридические услуги", "PROFESSIONAL_SERVICE"),
    "REAL_ESTATE": ("Недвижимость", "PROFESSIONAL_SERVICE"),
    "BANK": ("Банки и финансовые услуги", "OTHER"),
    "INSURANCE": ("Страхование", "PROFESSIONAL_SERVICE"),
    "LEARNING_CENTER": ("Учебные центры", "EDUCATION"),
    "LANGUAGE_SCHOOL": ("Языковые школы", "EDUCATION"),
    "KINDERGARTEN": ("Детские сады", "EDUCATION"),
    "SHOPPING_MALL": ("Торговые центры", "RETAIL"),
    "CAR_WASH": ("Автомойки", "AUTO_SERVICE"),
    "TIRE_SERVICE": ("Шиномонтаж", "AUTO_SERVICE"),
}
GROUPS = {
